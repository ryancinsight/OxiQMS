...
test.describe('Reports API Web Interface', () => {
  let page: Page;
  ...
  test('should display reports section with proper navigation', async () => {
    // Navigate to Reports section
    await page.click('a[href="#reports"]');

    // Verify Reports section loads
    await expect(page.locator('h2')).toContainText('Reports');
    await expect(page.locator('text=Medical Device Compliance Reports')).toBeVisible();
  ...
  test('should show reports API status and functionality', async () => {
    await page.click('a[href="#reports"]');
    ...
    await expect(page.locator('h3:has-text("Available Reports")')).toBeVisible();
  });

  test('should display all available report types', async () => {
    await page.click('a[href="#reports"]');

    // Verify all three report types are available
    await expect(page.locator('text=Audit Trail Report')).toBeVisible();
    await expect(page.locator('text=Design History File Report')).toBeVisible();
    await expect(page.locator('text=Risk Management Report')).toBeVisible();
  });

  test('should show proper report descriptions and compliance badges', async () => {
    await page.click('a[href="#reports"]');

    // Audit Trail Report
    await expect(page.locator('text=Comprehensive audit trail report for regulatory compliance')).toBeVisible();
    await expect(page.locator('text=FDA 21 CFR Part 820').first()).toBeVisible();
    await expect(page.locator('text=21 CFR Part 11').first()).toBeVisible();

    // Design History File Report
    await expect(page.locator('text=Design History File summary for medical device documentation')).toBeVisible();

    // Risk Management Report
    await expect(page.locator('text=Risk assessment and management report per ISO 14971')).toBeVisible();
    await expect(page.locator('text=ISO 14971').first()).toBeVisible();
  });

  test('should provide format selection for reports', async () => {
    await page.click('a[href="#reports"]');
    ...
    expect(await formatSelectors.count()).toBeGreaterThanOrEqual(3);

    // Verify report generation buttons are available
    const generateButtons = page.locator('button:has-text("Generate Report")');
    expect(await generateButtons.count()).toBeGreaterThanOrEqual(3);
  });

  test('should generate Audit Trail Report successfully', async () => {
    await page.click('a[href="#reports"]');
    ...
    await expect(page.locator('h3:has-text("Generated Reports")')).toBeVisible();
    ...
    await expect(page.locator('text=Format: HTML')).toBeVisible();
  });

  test('should generate Risk Management Report successfully', async () => {
    await page.click('a[href="#reports"]');
    ...
    if (buttonCount >= 3) {
      ...
      await expect(riskReportButton).toBeVisible();
    ...
    if (await riskReport.count() > 0) {
      ...
      await expect(page.locator('text=ISO 14971').first()).toBeVisible();
      await expect(page.locator('text=Risk Management Report').first()).toBeVisible();
    }
  });

  test('should show proper report content and formatting', async () => {
    await page.click('a[href="#reports"]');
  ...
  test('should provide download functionality for generated reports', async () => {
    await page.click('a[href="#reports"]');
  ...
  test('should provide print functionality for generated reports', async () => {
    await page.click('a[href="#reports"]');
  ...
  test('should handle multiple report generation', async () => {
    await page.click('a[href="#reports"]');
  ...
  test('should maintain regulatory compliance in report content', async () => {
    await page.click('a[href="#reports"]');
  ...
  test('should maintain responsive design for reports interface', async () => {
